...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bwege4c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bwege4c.containers.anotherwebservice.com/
...
```
git clone git@github.com:lil-ayushg/container-bwege4c.git
cd container-bwege4c
```
...
```
docker attach container-bwege4c
```
